-- Create demo users in auth system and then add sample data
-- We'll create the demo and guest accounts first, then add data for them

-- Create a function to setup demo data for new users
...
-- Update the handle_new_user function to setup demo data for demo accounts
